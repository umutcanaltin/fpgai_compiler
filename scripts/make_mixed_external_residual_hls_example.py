...
def write_model(path: Path) -> Path:
    ...
    nodes = [
        ...
        helper.make_node("Add", ["relu_out", "scaled"], ["summed"], name="add_0"),
        helper.make_node("Sigmoid", ["summed"], ["output"], name="sigmoid_0"),
    ]
    graph = helper.make_graph(
        nodes,
        "mixed_external_residual_add",
...
def main() -> None:
    ...
    parser.add_argument("--out", default="models/mixed_external_residual_add.onnx")
