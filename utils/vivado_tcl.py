def vivado_tcl_generator(project_name,project_dir, ip_repo_dir):
    vivado_str = ""
    vivado_str += "set project_name " + project_name + "\n"
    vivado_str += "set project_dir " +  project_dir + "\n"
    vivado_str += "set ip_repo_dir " + ip_repo_dir + "/solution1/impl/ip\n"
    vivado_str += """set top_module "deeplearn_0"
        ...
        """
    vivado_str += "make_wrapper -files [get_files " + project_dir +"/"+ project_name + ".srcs/sources_1/bd/deeplearn_bd/deeplearn_bd.bd] -top\n"
    vivado_str += "add_files -norecurse "+project_dir+"/"+project_name+".gen/sources_1/bd/deeplearn_bd/hdl/deeplearn_bd_wrapper.v\n"
    vivado_str += """
