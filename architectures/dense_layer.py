...
"""
    ...
    def get_inference_func(self):
        dense_layer_string = ""
        if(self.is_first_layer):
            dense_layer_string += "dense_layer_forward(input_matrix,"+self.name_of_layer +"_bias," +self.name_of_layer + "_weights,"+self.name_of_layer + "_output,"+str(self.input_shape)+","+str(self.output_shape)+");"+ '\n'
        elif(self.is_last_layer):
            dense_layer_string += "dense_layer_forward("+self.name_of_layer +"_input,"+self.name_of_layer +"_bias," +self.name_of_layer + "_weights,"+self.name_of_layer + "_output,"+str(self.input_shape)+","+str(self.output_shape)+");"+ '\n'
        else:
            dense_layer_string += "dense_layer_forward("+self.name_of_layer +"_input,"+self.name_of_layer +"_bias," +self.name_of_layer + "_weights,output_matrix,"+str(self.input_shape)+","+str(self.output_shape)+");"+ '\n'
