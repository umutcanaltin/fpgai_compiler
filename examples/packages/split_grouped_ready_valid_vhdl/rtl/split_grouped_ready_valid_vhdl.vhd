...
entity split_grouped_ready_valid_vhdl is
  port (
    clk          : in  std_logic;
    rst_n        : in  std_logic;
    ...
    left_data    : out signed(15 downto 0);
    right_data   : out signed(15 downto 0)
  );
end entity;

architecture rtl of split_grouped_ready_valid_vhdl is
