...
| figure_15_precision_numeric_error | created | paper_results/plots/figures/figure_15_precision_numeric_error.svg | Inference precision numeric error against the Python/ONNX reference for precision-focused rows, generated only when reference-output comparison artifacts are available. | — |
| figure_16_precision_resource_numeric_tradeoff | created | paper_results/plots/figures/figure_16_precision_resource_numeric_tradeoff.svg | Precision tradeoff between reference-output error and implemented LUT cost, generated from numeric-validation and Vivado artifacts. | — |
| figure_17_training_gradient_fidelity | created | paper_results/plots/figures/figure_17_training_gradient_fidelity.svg | Training gradient fidelity against the Python reference across on-device-training rows, generated from numeric-validation artifacts. | — |
| figure_18_inference_quality_vs_lut | created | paper_results/plots/figures/figure_18_inference_quality_vs_lut.svg | Inference task-quality/resource decision plot. When labels are available, quality can be task accuracy; otherwise it uses generated-vs-reference prediction agreement. | — |
| figure_19_precision_decision_lut_saving | created | paper_results/plots/figures/figure_19_precision_decision_lut_saving.svg | Precision decision plot showing implemented LUT saving versus the fx16 baseline for precision-focused rows. | — |
| figure_20_error_vs_bram | created | paper_results/plots/figures/figure_20_error_vs_bram.svg | Precision decision plot showing output error versus implemented BRAM usage. | — |
| figure_21_training_loss_delta | created | paper_results/plots/figures/figure_21_training_loss_delta.svg | Training decision plot showing loss change over the available reference/testbench training step artifacts. | — |
| figure_22_training_update_vs_lut | created | paper_results/plots/figures/figure_22_training_update_vs_lut.svg | Training decision plot showing update-direction fidelity against implemented LUT cost. | — |
