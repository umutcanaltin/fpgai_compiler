...
E2A supports metadata registration, lookup, version-aware resolution, and deterministic inventories. Plugin loading, compiler dispatch, remote discovery, and production operations are outside this component.
