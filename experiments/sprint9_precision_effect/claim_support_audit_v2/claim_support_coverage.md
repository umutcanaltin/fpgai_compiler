...
| WARN | unsupported/partial claim areas | warnings=4 |

## Claim status

| Claim area | Status |
|---|---|
| `precision_policy_materialization` | `supported` |
| `per_design_estimate_vs_hls_traceability` | `incomplete` |
| `weight_storage_memory_strategy` | `not_yet_supported_or_not_swept` |
...
| WARN | weight/memory strategy knob coverage | partial only: optimization.parallel.partition_factor |
