...
Sprint 14A/B intentionally separates script generation from full hardware
...
* extracting report/evidence metadata later.
"""
...
def _hls_export_tcl(hls_dir: Path, out_dir: Path, top_name: str, part: str) -> str:
    ...
    return rf'''# Auto-generated by FPGAI Sprint 14A/B.
...
# downstream Vivado scripts and evidence extraction have one stable IP repo path.
...
def _create_bd_tcl(board_name: str, top_name: str) -> str:
    # Sprint 14C: real PYNQ-Z2/Zynq-7020 block-design wiring for the exported
    ...
    return f"""# Auto-generated FPGAI Sprint 14C full block design.
...
def _run_vivado_tcl(board: Dict[str, Any], top_name: str, run_impl_default: bool) -> str:
    ...
    return rf'''# Auto-generated by FPGAI Sprint 14C.
...
This folder was generated by FPGAI Sprint 14A/B.
...
- `vivado_bridge_manifest.json`: machine-readable evidence/configuration metadata.

## Automated command from repo root

```bash
python scripts/run_vivado_bridge.py <experiment_dir> --board pynq_z2 --export-hls-ip
python scripts/run_vivado_bridge.py <experiment_dir> --board pynq_z2 --export-hls-ip --run-vivado-synth
python scripts/run_vivado_bridge.py <experiment_dir> --board pynq_z2 --export-hls-ip --run-vivado-impl
```
...
def generate_vivado_bridge_for_artifact(
    ...
    _write(out_dir / "vivado_bridge_manifest.json", json.dumps(evidence, indent=2, sort_keys=True))
    return evidence
...
def generate_vivado_bridge_for_experiment(
    ...
    for art in _iter_artifacts(exp):
        try:
            ...
            ev["design"] = art.name
            ev["status"] = "generated"
        except Exception as exc:  # keep evidence-driven behavior across all records
            ev = {
                "design": art.name,
                "status": "error",
        ...
        rows.append(ev)
    out = exp / "vivado_bridge_evidence.json"
