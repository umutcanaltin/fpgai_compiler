...
def try_import_external_node(*, graph, node, op_name: str, attrs: Mapping[str,Any], domain: str, opset: int, context: ExternalOperatorContext) -> Op|None:
    ...
    provenance={"package_id":selected.package_id,"package_version":selected.package_version,"operator_id":definition.contract.operator_id,"manifest_sha256":selected.manifest_hash}
