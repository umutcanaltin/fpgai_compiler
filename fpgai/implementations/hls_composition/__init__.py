...
from .external_call_codegen import (
    emit_external_call, emit_external_tensor_ports_call, package_declarations,
    package_training_declarations, emit_external_backward_input_call,
)
...
__all__ = [
    ...
    "build_hls_composition_plan", "emit_external_call", "emit_external_tensor_ports_call", "package_declarations",
    "package_training_declarations", "emit_external_backward_input_call",
