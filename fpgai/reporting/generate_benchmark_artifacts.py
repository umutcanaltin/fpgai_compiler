...
def write_summary_txt(df: pd.DataFrame, out_path: Path) -> None:
    lines: List[str] = []
    lines.append("FPGAI Final Benchmark Experiment Summary")
    lines.append("=" * 40)
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--outdir", required=True, help="output folder for benchmark artifacts")
...
def main() -> int:
    ...
    print(f"[OK] Benchmark artifacts written to: {outdir}")
    return 0
