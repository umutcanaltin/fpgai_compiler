    ...
    claim_rows = [
        {
            ...
            "evidence": "mode 0 preload, mode 1 weights snapshot, mode 2 training step",
        },
        {
            ...
            "evidence": "grads.bin, weights_before.bin, weights_after.bin generated by C simulation",
        },
        {
            ...
            "evidence": "training_compare/results.json with gradient and weight-update metrics",
        },
        {
            "claim": "Full multi-epoch training convergence on hardware",
            "status": "not claimed by this sprint",
            "evidence": "this sprint validates one training step; convergence remains a future experiment",
        },
    ]
